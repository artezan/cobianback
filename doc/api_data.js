define({ "api": [
  ...
  },
  {
    ...
    "name": "deleteByToken",
    "group": "adviser",
    "filename": "src/router/BuildRouter.ts",
    "groupTitle": "adviser",
    "sampleRequest": [
      {
  ...
  },
  {
    ...
    "name": "deleteByToken",
    "group": "goal",
    "filename": "src/router/MakerRouter.ts",
    "groupTitle": "goal",
    "sampleRequest": [
      {
        "url": "https://cobianback.herokuapp.com/api/v1/goal/:id"
  ...
  },
  {
    ...
    "filename": "src/router/SalesRouter.ts",
    "groupTitle": "status",
    "sampleRequest": [
      {
        "url": "https://cobianback.herokuapp.com/api/v1/status/upgradelevelbyid/:id"
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://cobianback.herokuapp.com/api/v1/status/bybuyerpropid/"
      }
    ]
  },
  {
